...
getMajors <- function(days) {

  tryCatch(
    expr = {
      payload <- xml2::read_html(paste0("https://www.baseball-reference.com/leagues/daily.fcgi?request=1&type=b&dates=lastndays&lastndays=",days,"&since=2024-12-01&fromandto=2024-12-01.2024-12-31&level=mlb&franch=ANY&stat_value=0"))
      df <- payload %>%
