...
minorDaily <- function(t1, t2) {

  tryCatch(
    expr = {
      payload <- xml2::read_html(paste0("http://www.baseball-reference.com/leagues/daily.cgi?request=1user_team=&type=b&lastndays=7&dates=fromandto&fromandto=", t1, ".", t2, "&level=milb&franch=&stat=b%3AH&stat_value=10"))
      df <- payload %>%
